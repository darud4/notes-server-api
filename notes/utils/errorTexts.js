...
module.exports.ERRMSG_NOTE_CANNOT_BE_UPDATED = 'При изменении заметки произошла ошибка';

module.exports.ERRMSG_DELETE_NOTE_NOT_YOURS = 'Нельзя удалить чужую заметку';
module.exports.ERRMSG_NOTE_CANNOT_BE_DELETED = 'При удалении заметки произошла ошибка';
